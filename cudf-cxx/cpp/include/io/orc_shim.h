...
std::unique_ptr<OwnedTableWithMetadata> read_orc_with_metadata(rust::Str filepath, rust::Slice<const rust::String> columns, int64_t skip_rows, int64_t num_rows);
