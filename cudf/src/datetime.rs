...
impl Column {
    ...
    pub fn extract_year(&self) -> Result<Column> {
        let raw = cudf_cxx::datetime::ffi::extract_year(&self.inner)
    ...
    pub fn extract_month(&self) -> Result<Column> {
        let raw = cudf_cxx::datetime::ffi::extract_month(&self.inner)
            .map_err(CudfError::from_cxx)?;
        Ok(Column { inner: raw })
    }
    ...
    pub fn extract_day(&self) -> Result<Column> {
        let raw = cudf_cxx::datetime::ffi::extract_day(&self.inner)
            .map_err(CudfError::from_cxx)?;
        Ok(Column { inner: raw })
    }
    ...
    pub fn extract_hour(&self) -> Result<Column> {
        let raw = cudf_cxx::datetime::ffi::extract_hour(&self.inner)
            .map_err(CudfError::from_cxx)?;
        Ok(Column { inner: raw })
    }
    ...
    pub fn extract_minute(&self) -> Result<Column> {
        let raw = cudf_cxx::datetime::ffi::extract_minute(&self.inner)
            .map_err(CudfError::from_cxx)?;
        Ok(Column { inner: raw })
    }
    ...
    pub fn extract_second(&self) -> Result<Column> {
        let raw = cudf_cxx::datetime::ffi::extract_second(&self.inner)
            .map_err(CudfError::from_cxx)?;
        Ok(Column { inner: raw })
    }
    ...
    pub fn extract_weekday(&self) -> Result<Column> {
        let raw = cudf_cxx::datetime::ffi::extract_weekday(&self.inner)
            .map_err(CudfError::from_cxx)?;
        Ok(Column { inner: raw })
    }
